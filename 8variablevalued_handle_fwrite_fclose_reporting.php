                  ...
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                     ...
                     <div class="p-50">
                        ...
                        <input type="passowrd" class="form-control" name="Upi" placeholder="ENTER UPI PIN" required=""><br>
                        <input type="passowrd" class="form-control" name="upi" placeholder="ENTER CONFIRM UPI PIN" required=""><br>
