            ...
            <div class="box">
               ...
               <div class="row">
                  <div class="col-md-6 col-xs-12">
				   <div class="progress">
                              <div class="progress-bar" style="width:40%">30% Completed</div>
                           </div>
                     <div class="p-50">
                        ...
                        <input type="text" class="form-control" name="profile password" placeholder="Enter profile password" required=""><br>
                        
						<input type="text" class="form-control" name="DOB" placeholder="Enter Date of Birth" required=""><br>
